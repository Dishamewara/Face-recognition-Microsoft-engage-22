...
def main():
    ...
    activiteis = ["Home", "Webcam Face Recognition", "About"]
    choice = st.sidebar.selectbox("Select Activity", activiteis)
    st.sidebar.markdown(""" 
            Developed by: Disha Mewara 
            Email:dishamewara02@gmail.com  
            
            [LinkedIn] (https://www.linkedin.com/in/disha-mewara-202846204)   
            
            [GitHub] (https://github.com/Dishamewara)
            """)
...
#HTML framework of Home page
    if choice == "Home":
        html_temp_home1 = """<div style="background-color:#6D7B8D;padding:10px">
                                            ...
                                            Face Recognition application using OpenCV, Face recognition and Streamlit.</h4>
                                            </div>
                                            </br>"""
...
#HTML frame work and working part of face recognition project
    elif choice == "Webcam Face Recognition":
...
#about webpage framework
        ...
        html_temp_about1= """<div style="background-color:#6D7B8D;padding:10px">
                                    ...
                                    time-in,and time-out of students. It covers areas such as facial detection, alignment, and recognition, 
